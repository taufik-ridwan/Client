...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        MatHax.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        MatHax.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        MatHax.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        MatHax.EVENT_BUS.unsubscribe(staticInstadropListener);
    }

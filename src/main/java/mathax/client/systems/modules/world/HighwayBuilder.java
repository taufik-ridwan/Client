...
import mathax.client.utils.misc.MBlockPos;
import mathax.client.utils.player.CustomPlayerInput;
...
public class HighwayBuilder extends Module {
    ...
    private final Setting<SettingColor> renderMineSideColor = sgRenderMine.add(new ColorSetting.Builder()
        ...
        .defaultValue(new SettingColor(MatHax.INSTANCE.MATHAX_COLOR.r, MatHax.INSTANCE.MATHAX_COLOR.g, MatHax.INSTANCE.MATHAX_COLOR.b, 150))
        .build()
    );

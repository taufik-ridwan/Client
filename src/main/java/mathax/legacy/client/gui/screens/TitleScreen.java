...
public class TitleScreen extends Screen {
    ...
    protected void init() {
        ...
        addDrawableChild(new ButtonWidget(width / 2 - 204, y + (spacingY * 2), 200, 20, new LiteralText("Website"), (button) -> Util.getOperatingSystem().open(MatHaxLegacy.URL)));
        addDrawableChild(new ButtonWidget(width / 2 + 4, y + (spacingY * 2), 200, 20, new LiteralText("Discord"), (button) -> Util.getOperatingSystem().open(MatHaxLegacy.URL + "Discord")));
